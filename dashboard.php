                    ...
                    <header>
                            ...
                            <div style="padding: 4vw; background-color:#375679;">
                                ...
                                <div class="row" style="display: flex; flex-wrap: wrap; gap: 3vw;">
                                    <div class="col-md-6 bg-white"
                                        ...
                                        <div id="gambar-bulat-utama"
                                            style="position: relative; width: 15vw; min-width:120px;">
                                            <img src="image/Subtract.png" alt=""
                                        ...
                                        <!-- Gambar 3r  -->
                                        <p
                                            style="font-size:12px;font-weight:600;position: absolute; top: 195px; left: 65vw;">
                                            Capaian NLP</p>
                                        <p id="tulisan-quiz-nlp-selesai"
                                            style="font-size:9px;font-weight:600;position: absolute; top: 200px; left: 100px;">
                                            Quiz NLP <br>
                                            selesai</p>
                                        <p id="tulisan-quiz-subbab-dikuasai"
                                            style="font-size:9px;font-weight:600;position: absolute; top: 210px; left: 28vw;">
                                            Subbab <br>
                                            dikuasai</p>
                                        <p id="tulisan-quiz-subbab-baru-dipelajari"
                                            style="font-size:9px;font-weight:600;position: absolute; top: 210px; left: 52vw;">
                                            Subbab baru <br>
                                            dipelajari</p>
                                        <i id="arrow-tengah"
                                        ...
                                        <div class=""
                                            ...
                                            <div style="display: flex; gap: 5vw;">
                                                <div
                                                    style="display: flex; width: 40vw; align-items: center; justify-content: center;">
                                                ...
                                                <div
                                                    ...
                                                    <div class="text-center" id="tulisan-bawah-gambar" style="">
                                                        ...
                                                        <span style="font-weight: 600; color:#650505"> Belum
                                                            terpenuhi</span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="mt-2" style="display: flex; gap:120px;">
                                                ...
                                                <div
                                                    style="display: flex; width: 25vw; align-items: center; justify-content: center;">
                                                    <div
                                    ...
                                    <div class="col-md-5 bg-white p-4 rounded"
                                        ...
                                        <div style="color: #1F2844; padding:4vw;">
                                            ...
                                            <p style="margin-bottom: 1.5rem;">Kamu terakhir mempelajari <b>Limit Tak
                                                    Hingga - Subbab III</b>. Pengen
                                                lanjut lagi?</p>
                        ...
                        <section id="nlp-desktop">
                            <div style="padding: 4vw 4vw 4vw 3vw; background-color:#375679;">
                                ...
                                <div style="display:flex; gap:3vw;">
                                    <div class="bg-white"
                                        style="height:30vw; width:60vw; padding:0vw 4vw 1vw 4vw; border-radius:1vw;">
                                        <!-- Gmbar Bulat -->
                                        <p
                                            style="font-size:1.8vw;font-weight:600;position: absolute; top: 16vw; left: 8vw;">
                                            Persentase NLP minggu ini</p>
                                        <div style="position: relative; width: 15vw; height: auto;">
                                            <img src="image/Subtract.png" alt=""
                                                style="width: 100%; position: absolute; top: 6vw; left: 4vw; z-index: 1;">
                                        ...
                                        <!-- Gambar 3r  -->
                                        <p
                                            style="font-size:1.8vw;font-weight:600;position: absolute; top: 16vw; left: 37vw;">
                                            Capaian NLP</p>
                                        <p
                                            style="font-size:1.3vw;font-weight:600;position: absolute; top: 21vw; left: 31vw;">
                                            Quiz NLP <br>
                                            selesai</p>
                                        <p
                                            style="font-size:1.3vw;font-weight:600;position: absolute; top: 26vw; left: 28vw;">
                                            Subbab <br>
                                            dikuasai</p>
                                        <p
                                            style="font-size:1.3vw;font-weight:600;position: absolute; top: 26vw; left: 52vw;">
                                            Subbab baru <br>
                                            dipelajari</p>
                                        ...
                                        <div style="transform:scale(0.45)">
                                            ...
                                            <div
                                                ...
                                                <div
                                                    style="display: flex; justify-content: space-between; margin-top: 10px;">
                                                    <div style="position: relative; display: inline-block;">
                                                        <img style="margin-right: 10px;" src="image/3r/3rputih_kiri.png"
                                                            alt="">
                                                    </div>
                                                    <div style="position: relative; display: inline-block;">
                                                        <img src="image/3r/3rputih_kanan.png" alt="">
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <div style="position: relative; display: inline-block;">
                                                        <img style="clip-path: inset(40% 0 0 0);"
                                                            src="image/3r/3rhijau_kanan.png" alt="">
                                                        <div
                                                            style=" position: absolute; top: 2vw; left: 0; width: 100%; height: 100%; display: flex; justify-content: center; align-items: center; z-index: 4; color: black; font-size: 3.2vw; font-weight:600">
                                                            5/7
                                        ...
                                        <div class=""
                                            ...
                                            <div style="display: flex; gap: 5vw;">
                                                <div
                                                    style="display: flex; width: 20vw; align-items: center; justify-content: center;">
                                                ...
                                                <div
                                                    ...
                                                    <div class="text-center">
                                                        Target NLP mingguan: <br>
                                                        <spans style="font-weight: 600; color:#650505"> Belum terpenuhi
                                                        </spans>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="bg-white"
                                        style="height:30vw; width:40vw; border-radius: 1vw; padding:5vw;">
                                        <div style="color: #1F2844;">
                                            <p>Halo <b><?= $_SESSION['user_name'] ?></b>!</p>
                                            <p style="margin-bottom: 2vw">Kamu terakhir mempelajari <b>Limit Tak Hingga
                                                    - Subbab
                                ...
                                <div style="background-color: #E3ECF5; border-radius: 0.5vw; padding: 2vw 3vw;">
                                    <div style="background-color: white; border-radius: 0.5vw; padding: 2vw 1vw 2vw 3vw;"
                                        ...
                                        <table style="border-collapse: collapse;">
                                            <tr>
                                                <td rowspan="4" style="padding-right: 1.5vw;"><img src="image/Bab.png"
                        ...
                        <footer class="d-flex align-items-center  text-white py-3"
                            style="width: 100%; background-color:#1F2844;">
                            <div class="container d-flex justify-content-start align-items-center">
                                <img src="image/logo otodu terang.png" alt="logo" class="img-fluid me-3"
                                    style="width: 20vw; max-width: 120px;">
                                <p class="mb-0" style="font-family: 'Martian Mono'; font-size: 0.9rem;">©2024 OTODU
                                    Limited</p>
                            </div>
                        </footer>
                        ...
                        <footer>
                            ...
                            <p style="font-family: 'Martian Mono'; font-size: 10px; margin-top: 17px;">@2024 OTODU
                                Limited</p>
                        </footer>

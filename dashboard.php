            ...
            <div style="padding: 4vw; background-color:#375679;">
                ...
                <div class="row" style="display: flex; flex-wrap: wrap; gap: 3vw;">
                    <div class="col-md-6 bg-white"
                        ...
                        <!-- Gmbar Bulat -->
                        <p id="header-gambar-bulat" style="font-size:12px;font-weight:600;position: absolute; top:150px; left: 4vw;">
                        ...
                        <!-- Gmbar Bulat Akhir -->
                        <!-- Gambar 3r  -->
                        <p style="font-size:12px;font-weight:600;position: absolute; top: 195px; left: 65vw;">Capaian NLP</p>
                        <p id="tulisan-quiz-nlp-selesai"
                            style="font-size:9px;font-weight:600;position: absolute; top: 200px; left: 100px;">Quiz NLP <br>
                            selesai</p>
                        <p id="tulisan-quiz-subbab-dikuasai"
                            style="font-size:9px;font-weight:600;position: absolute; top: 210px; left: 28vw;">Subbab <br>
                            dikuasai</p>
                        <p id="tulisan-quiz-subbab-baru-dipelajari"
                            style="font-size:9px;font-weight:600;position: absolute; top: 210px; left: 52vw;">Subbab baru <br>
                            dipelajari</p>
                        <i id="arrow-tengah"
                        ...
                        <div style="transform:scale(0.45)">
                            ...
                            <div class="container-3r" id="container-3r-1"
                                ...
                                <div style="display: flex; justify-content: space-between; margin-top: 10px;">
                                    <div style="position: relative; display: inline-block;">
                                        <img style="margin-right: 10px; width:15vw; min-width:140px;" src="image/3r/3rputih_kiri.png" alt="">
                                    </div>
                                    <div style="position: relative; display: inline-block;">
                                        <img src="image/3r/3rputih_kanan.png" alt="" style="width:15vw; min-width:140px;">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class=""
                            ...
                            <div class="mt-2" style="display: flex; gap:120px;">
                                <div style="margin-left:4vw; display: flex; width: 20vw; align-items: center; justify-content: center;">
                                    <div style="width: 10vw; min-width:100px; height: 5px; background-color: #46CC6A; border-radius: 1vw;">
                                    </div>
                                ...
                                <div style="display: flex; width: 25vw; align-items: center; justify-content: center;">
                                    <div style="width: 10vw; min-width:100px; height: 5px; background-color: #C4CBE0; border-radius: 1vw;">
                                    </div>
                    ...
                    <div class="col-md-5 bg-white p-4 rounded" style="height:30vw; min-height:220px; border-radius: 1vw;">
                        <div style="color: #1F2844; padding:4vw;">
                            <p>Halo <b>
                                    <?= $_SESSION['user_name'] ?>
                                </b>!</p>
                            <p style="margin-bottom: 1.5rem;">Kamu terakhir mempelajari <b>Limit Tak Hingga - Subbab III</b>. Pengen
                                lanjut lagi?</p>
                            <p class="text-white text-center"
                                style="background-color:#375679; border-radius: 8px; padding: 0.5rem; cursor: pointer;">Lanjut Belajar</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div style="padding: 4vw 4vw 4vw 3vw; background-color:#375679;">
                ...
                <div style="display:flex; gap:3vw;">
                    <div class="bg-white" style="height:30vw; width:60vw; padding:0vw 4vw 1vw 4vw; border-radius:1vw;">
                        <!-- Gmbar Bulat -->
                        <p style="font-size:1.8vw;font-weight:600;position: absolute; top: 16vw; left: 8vw;">Persentase NLP minggu ini</p>
                        ...
                        <!-- Gmbar Bulat Akhir -->
                        <!-- Gambar 3r  -->
                        <p style="font-size:1.8vw;font-weight:600;position: absolute; top: 16vw; left: 37vw;">Capaian NLP</p>
                        ...
                        <p style="font-size:1.3vw;font-weight:600;position: absolute; top: 26vw; left: 52vw;">Subbab baru <br>
                            dipelajari</p>
                        <i style="transform: rotate(-20deg);position: absolute; top: 21vw; left: 38vw; font-size: 1.5vw" class="bi bi-arrow-up-left"></i>
                        <i style="transform: rotate(-20deg);position: absolute; top: 28vw; left: 34vw; font-size: 1.5vw" class="bi bi-arrow-up-left"></i>
                        <i style="transform: rotate(90deg);position: absolute; top: 28vw; left: 50vw; font-size: 1.5vw" class="bi bi-arrow-up-left"></i>

                        <div style="transform:scale(0.45)">
                            <!-- Container untuk gambar pertama -->

                            <div style="position: absolute; top: 7vw; left: 30vw; display: inline-block; text-align: center;">
                                <!-- Gambar tengah putih -->
                            ...
                            <!-- Container untuk gambar kedua -->
                            <div style="position: absolute; top: 7vw; left: 30vw; display: inline-block; pointer-events: none; text-align: center;">
                                <!-- Gambar tengah hijau -->
                                <div style="position: relative; display: inline-block;">
                                    <img src="image/3r/3rhijau_tengah.png" alt=""
                                        style="position: relative; top: 60px; display: block; margin-left: auto; margin-right: auto; clip-path: inset(50% 0 0 0);">
                                    <div style=" position: absolute; top: 4vw; left: 0; width: 100%; height: 100%; display: flex; justify-content: center; align-items: center; z-index: 4; color: black; font-size: 3.2vw; font-weight:600">
                                        15/27
                                    </div>
                                </div>
                                <!-- Gambar kiri dan kanan hijau -->
                                <div style="display: flex; justify-content: space-between; margin-top: 10px;">
                                    <div style="position: relative; display: inline-block;">
                                        <img style="margin-right: 10px; clip-path: inset(70% 0 0 0);" src="image/3r/3rhijau_kiri.png" alt="">
                                        <div style=" position: absolute; top: 2vw; left: 0; width: 100%; height: 100%; display: flex; justify-content: center; align-items: center; z-index: 4; color: black; font-size: 3.2vw; font-weight:600">
                                            2/5
                                        </div>
                                    </div>
                                    <div style="position: relative; display: inline-block;">
                                        <img style="clip-path: inset(40% 0 0 0);" src="image/3r/3rhijau_kanan.png" alt="">
                                        <div style=" position: absolute; top: 2vw; left: 0; width: 100%; height: 100%; display: flex; justify-content: center; align-items: center; z-index: 4; color: black; font-size: 3.2vw; font-weight:600">
                                            5/7
                                        </div>
                                    </div>
                    ...
                    <div class="bg-white" style="height:30vw; width:40vw; border-radius: 1vw; padding:5vw;">
                        <div style="color: #1F2844;">
                            ...
                            <p style="margin-bottom: 2vw">Kamu terakhir mempelajari <b>Limit Tak Hingga - Subbab
        ...
        <section id="konten">
            <div style="padding: 4vw 4vw 4vw 7vw;">
                ...
                <div style="background-color: #E3ECF5; border-radius: 0.5vw; padding: 2vw 3vw;">
                    <div style="background-color: white; border-radius: 0.5vw; padding: 2vw 1vw 2vw 3vw;"
                        id="bab">

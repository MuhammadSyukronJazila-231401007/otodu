                      ...
                      <div class="modal-content">
                          ...
                          <div class="modal-body">
                              <div style="display: flex; background-color: #375679; border-radius: 0.5vw; margin-bottom: 2vw;">
                                  <div style="margin-top: 0.8vw; color: #F6F7FA; border-radius: 4vw; font-size: 1.5vw; padding-left: 0.25vw; padding-right: 0.25vw; margin: 1.2vw 1vw 1.2vw 2.5vw;">
                              ...
                              <div style="display: flex; justify-content: space-around">
                                  <div style="width: 40vw; height: 30vw; background-color: white; border-radius: 0.5vw;">
                                      <center>
                                        <div style="display: flex; align-items: center;">
                                          <img src="image/user.png" alt="User Image" style="width: 50px; margin-right: 15px;">
                                          
                                          <div style="display: flex; flex-direction: column; border-bottom: 1px solid black;">
                                            <p>Mentor Skibdi L., S.Komedi</p>
                                            
                                            <div style="display: flex; align-items: center;">
                                              <img src="image/pinhitam.png" alt="Location Pin" style="width: 20px; margin-right: 5px;">
                                              <div>690 m</div>
                                            </div>
                                            
                                          </div>                                          
                                        </div>
                                        <div style="border-bottom: 1px solid #3A425A; color: #3A425A; padding-bottom: 4px; display: flex; align-items: center;">
                                          <font>Mengajar</font>
                                      </div>
                                  
                                      <div style="display: flex; gap: 10px; align-items: center; margin-top: 1vw;">
                                          <span style="padding: 10px 20px; background-color: #FF6F00; color: white; border-radius: 5px; font-size: 16px;">Matematika</span>
                                          <span style="padding: 10px 20px; background-color: #388E3C; color: white; border-radius: 5px; font-size: 16px;">Dasar Pemrograman</span>
                                          <span style="padding: 10px 20px; background-color: #1976D2; color: white; border-radius: 5px; font-size: 16px;">UTBK</span>
                                      </div>
                                    ...
                                    <div style="display: flex; flex-direction: column; gap: 10px; margin-top: 1vw;">
                                      <span style="padding: 5px 10px; background-color: #FF6F00; color: white; border-radius: 5px; font-size: 16px;">Luring @ 13:00 - 16:00, 16:30 - 19:00</span>
                                      <span style="padding: 5px 10px; background-color: #388E3C; color: white; border-radius: 5px; font-size: 16px;">Daring @ 13:00 - 16:00, 16:30 - 19:00, 19:30 - 22:30</span>
                                  </div>                                  
                                ...
                                <div style="display: flex; flex-direction: column; gap: 10px; margin-top: 10px; align-items: flex-start;">
                                    <p style="font-size: 16px; color: #3A425A; margin: 0;">Sarjana Ilmu Komedi - Universitas Kampus Institut</p>
                                    <p style="font-size: 16px; color: #3A425A; margin: 0;">Magister Sastra Mesin - Institut Teknologi Dimensi</p>
                                </div>                                
                                  ...
                                  <div style="width: 40vw; height: 30vw; background-color: white; border-radius: 0.5vw;">
                                      <div style="margin-top: 1vw; text-align: center;">
                                        ...
                                        <div style="color: #3A425A; padding-bottom: 4px; display: flex; align-items: center;">
                                      ...
                                      <div style="margin-top: 10px; display: flex; flex-direction: column; align-items: flex-start;">
                                          <select style="padding: 10px 20px; font-size: 16px; color: #3A425A; border: 1px solid #3A425A; border-radius: 5px; width: 100%;">
                                              <option value="matematika" style="font-weight: bold;">Matematika</option>
                                          </select>
                                      </div>
                                      ...
                                      <div style="margin-top: 10px; display: flex; flex-direction: column; align-items: flex-start;">
                                          <select style="padding: 10px 20px; font-size: 16px; color: #3A425A; border: 1px solid #3A425A; border-radius: 5px; width: 100%;">
                                              <option value="Fungsi" style="font-weight: bold;">Matematika</option>
                                          </select>
                                      </div>
                                      ...
                                      <div style="margin-top: 10px; display: flex; flex-direction: column; align-items: flex-start;">
                                          <select style="padding: 10px 20px; font-size: 16px; color: #3A425A; border: 1px solid #3A425A; border-radius: 5px; width: 100%;">
                                              <option value="matematika" style="font-weight: bold;">Daring</option>
                                          </select>
                                      </div>
                                      
                                      <button style="margin-top: 20px; padding: 10px 0; background-color: #FF6F00; color: white; border: none; border-radius: 5px; font-size: 16px; width: 100%; text-align: center;">
                                        Pesan
                                    </button>

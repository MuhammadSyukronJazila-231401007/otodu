      ...
      <div style="display: flex;">
        ...
        <div style="background-color: #4D62A5; color: white; padding: 0;">
          <a href="riwayatmentor.php" class="btn btn-primary"
            style="background-color: #4D62A5;  font-size: 12px; text-align: center; border: 0cm;" tabindex="-1"
            role="button" aria-disabled="true">
          ...
          <table style="background-color: #4D62A5; border-radius: 1vw; ">
            ...
            <tr>
              <td colspan="3" style="text-align: end; padding: 0 0 4px 0; margin-top: 0;">
                ...
                <a class="btn btn-primary" data-bs-toggle="modal" href="#exampleModal" role="button" id="open"
                            ...
                            <center>
                              <div style="display: flex; align-items: center;">
                                ...
                                <div
                                  ...
                                  <p style="margin: 0; padding: 0; text-align: left">Mentor Skibidi L., S.Komedi</p>
                              ...
                              <div style="display: grid; gap: 10px; margin:auto; margin-top: 1vw;">
                                ...
                                <span
                                  style="padding: 7px 23px; background-color: #6A7937; color: white; border-radius: 13px; font-size: 13px; width: fit-content"><b>Daring
                                    @ 13:00 - 16:00, 16:30 - 19:00, 19:30 - 22:30</b></span>
                              </div>
                              ...
                              <div
                                ...
                                <p style="font-size: 16px; color: #3A425A; margin: 0;">Sarjana Ilmu Komedi - Universitas
                                  Kampus Institut</p>
                                <p style="font-size: 16px; color: #3A425A; margin: 0;">Magister Sastra Mesin - Institut
                                  Teknologi Dimensi</p>
                              </div>
                              ...
                              <div style="margin-top: 1vw; text-align: center;">
                                ...
                                <div style="margin-top: 1vw; text-align: center;">
                                  ...
                                  <div
                                    ...
                                    <select
                                      style="padding: 10px 20px; font-size: 16px; color: #3A425A; border: 1px solid #3A425A; border-radius: 5px; width: 100%;">
                                      <option value="Fungsi" style="font-weight: bold;">Daring</option>
                                    </select>
                                  </div>
                                  ...
                                  <div style="margin-top: 1vw; text-align: center;">
                                    ...
                                    <div
                                      ...
                                      <select
                                        style="padding: 10px 20px; font-size: 16px; color: #3A425A; border: 1px solid #3A425A; border-radius: 5px; width: 100%;">
                                        <option value="matematika" style="font-weight: bold;">13:00 - 14:00 WIB</option>
                                      </select>
                                    </div>
                                    ...
                                    <div style="margin-top: 1vw; text-align: center;">
                                      ...
                                      <div
                                        style="color: #3A425A; padding-bottom: 4px; display: flex; align-items: center;">
                                        <font>Deskripsi materi yang ingin dipelajari</font>
                                      </div>

                                      <div
                                        style="margin-top: 10px; display: flex; flex-direction: column; align-items: flex-start;">
                                          <textarea style="font-weight: bold; padding: 10px 20px; font-size: 16px; color: #3A425A; border: 1px solid #3A425A; border-radius: 5px; width: 100%; text-align:left">Izin kak, aku belum terlalu paham tentang fungsi komposisi, aku ada beberapa soal yang mungkin bisa tolong kak mentor ajar samaku? Terimakasih sebelumnya kak
                                          </textarea>
                                      </div>
                                    ...
                                    <div class="box1">
                                      ...
                                      <div>
                                        <p style="text-align: left; margin-left: 30px; margin-right: 30px;">
                                          Lorem ipsum dolor sit amet consectetur adipisicing elit. Rerum ad quo sunt
                                          sapiente
                                          vero
                                          possimus aperiam a qui, vel deleniti perferendis, eveniet quam voluptate!
                                          Perferendis
      ...
      <div>
        <center>
          <table style="background-color: #4D62A5; border-radius: 1vw; ">
            ...
            <tr>
              <td colspan="2" style="color: white; font-size: 7px; border-bottom: 1px solid white;"><img
                  src="./image/pin.png" width="17" height="17">690m</td>
            </tr>
            <tr>
              <td style="padding: 5px;"></td>
            ...
            <tr>
              <td colspan="3" style="text-align: end; padding: 0 0 4px 0; margin-top: 0;">
                ...
                <div class="modal fade" id="pesan2" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <table style="background-color: #4D62A5; border-radius: 1vw; ">
          ...
          <tr>
            <td colspan="3" style="text-align: end; padding: 0 0 4px 0; margin-top: 0;">
              ...
              <div class="modal fade" id="pesan3" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                aria-labelledby="staticBackdropLabel" aria-hidden="true">
                <div class="modal-dialog">
                  <div class="modal-content">
          ...
          <table style="background-color: #4D62A5; border-radius: 1vw; ">
            ...
            <tr>
              <td colspan="3" style="text-align: end; padding: 0 0 4px 0; margin-top: 0;">
                ...
                <div class="modal fade" id="pesan4" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                  aria-labelledby="staticBackdropLabel" aria-hidden="true">
                  <div class="modal-dialog">
                    <div class="modal-content">
        ...
        <table style="background-color: #4D62A5; border-radius: 1vw; ">
          ...
          <tr>
            <td colspan="3" style="text-align: end; padding: 0 0 4px 0; margin-top: 0;">
              ...
              <div class="modal fade" id="pesan5" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                aria-labelledby="staticBackdropLabel" aria-hidden="true">
                <div class="modal-dialog">
                  <div class="modal-content">
        ...
        <table style="background-color: #4D62A5; border-radius: 1vw; ">
          ...
          <tr>
            <td colspan="3" style="text-align: end; padding: 0 0 4px 0; margin-top: 0;">
              ...
              <div class="modal fade" id="pesan6" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                aria-labelledby="staticBackdropLabel" aria-hidden="true">
                <div class="modal-dialog">
                  <div class="modal-content">

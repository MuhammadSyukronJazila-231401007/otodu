...
<body style="font-family: 'Rethink Sans', sans-serif;">
    ...
    <main>
                    ...
                    <table style="background-color: #4D62A5; border-radius: 1vw; ">
                        ...
                        <tr>
                            <td colspan="3" style="text-align: end; padding: 0 0 4px 0; margin-top: 0;">
                                ...
                                <a class="btn btn-primary" data-bs-toggle="modal" href="#exampleModal" role="button"
                                    id="open" style="display: none;"></a>
                                        ...
                                        <div class="modal-content bg-transparent">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div style="display: flex; justify-content: space-around">
                                                            ...
                                                            <div
                                                                ...
                                                                <select
                                                                    ...
                                                                    <option value="matematika"
                                                                        style="font-weight: bold;">Matematika</option>
                                                                </select>
                                                            </div>
                                                            ...
                                                            <div style="margin-top: 1vw; text-align: center;">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <select
                                                                        style="padding: 10px 20px; font-size: 16px; color: #3A425A; border: 1px solid #3A425A; border-radius: 5px; width: 100%;">
                                                                        <option value="Fungsi"
                                                                            style="font-weight: bold;">Matematika
                                                                        </option>
                                                                    </select>
                                                                </div>
                                                    ...
                                                    <div class="modal fade" id="pesan1" data-bs-backdrop="static"
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <center>
                                                                        <div class="box1">
                                                                            <div class="box2">
                                                                                <img src="./image/user.png" width="80px"
                                                                                    height="80px"
                                                                                    style="margin-right: 30px;">
                                                                                <p>(Deskripsi)aaaaaaaaaaaaa
                                                                            ...
                                                                            <div>
                                                                                <p
                                                                                    ...
                                                                                    sapiente
                                                                                    vero
                                                                                    possimus aperiam a qui, vel deleniti
                                                                                    perferendis, eveniet quam voluptate!
                                                                                    Perferendis
                                                    ...
                                                    <div class="box1">
                                                            ...
                                                            <table class="tabel">
                                                                <tr>
                                                                    <td class="tabeltd" scope="col">
                                                                        ...
                                                                        <div style="text-align: center;">Dasar
                                                                            Pemrograman</div>
                                                                    </td>
                                                                    <td class="tabeltd" scope="col">
                                                                        <div style="text-align: center;">Sub-Materi:
                                                                        </div>
                                                                        <div style="text-align: center;">Bahasa C++,
                                                                            Java, HTML</div>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        ...
                                                        <div>
                                                            <p
                                                                ...
                                                                Rerum ad quo sunt sapiente vero
                                                                possimus aperiam a qui, vel deleniti perferendis,
                                                                eveniet quam voluptate! Perferendis
                                                                quaerat odit ea unde eaque!
                                                            </p>
                                                        </div>
                                                        <div class="box3">
                                                ...
                                                <div class="box1">
                                                    ...
                                                    <div>
                                                        <table class="tabel">
                                                            <tr>
                                                                <td class="tabeltd" scope="col">
                                                                    <div style="text-align: center;">Materi:</div>
                                                                    <div style="text-align: center;">Dasar Pemrograman
                                                                    </div>
                                                                </td>
                                                                <td class="tabeltd" scope="col">
                                                                    <div style="text-align: center;">Sub-Materi:</div>
                                                                    <div style="text-align: center;">Bahasa C++, Java,
                                                                        HTML</div>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    ...
                                                    <div>
                                                        <p
                                                            ...
                                                            Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                                            Rerum ad quo sunt sapiente vero
                                                            possimus aperiam a qui, vel deleniti perferendis, eveniet
                                                            quam voluptate! Perferendis
                                                            quaerat odit ea unde eaque!
                                                        </p>
                                                    </div>
                                                    <div class="box3">
        ...
        <!--Baris Kedua-->
        <div
            style="display: flex; margin-left: 5vw; margin-right: 5vw; justify-content: space-between; margin-top: 2vw;">
            <div>
                <center>
                    <table style="background-color: #4D62A5; border-radius: 1vw; ">
                        <tr>

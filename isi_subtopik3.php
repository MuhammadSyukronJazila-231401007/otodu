...
<body class="">
  ...
  <section class="" style="background-color:#375679; height:6vw;">
    ...
    <!-- Modal Bootstrap -->
    <div class="modal fade mt-5" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" style="display:none;">
  ...
  <div class="hasil" id="hasil-1"></div>
          ...
          <div id="materi7" class="content">
              ...
              <p style="font-size:15px;">Sudah sejauh ini, tapi apakah Anda sudah tahu mengapa kita mempelajari fungsi?  <br>
  ...
  <script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.11.8/dist/umd/popper.min.js" integrity="sha384-qhMzCV4IFxkpA4MecId+RYLTvIjKNwujuL9X5Ly7j7GsTLk/w1lU8H3N9bQKUf1K" crossorigin="anonymous"></script>
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.min.js" integrity="sha384-YTxKWbFVOUCU1iyXPLBtyHeOHzujwhDlbnEwOnJ/BcPg+3og4tkUmUP1fojKQLsk" crossorigin="anonymous"></script>

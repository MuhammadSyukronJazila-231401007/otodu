    ...
    <div id="kolomKiri" class="col-md-6">
        <div class="boxleft box-4">
            ...
            <div style="text-align: center; color: #000; margin-top: 2vw;">
                <div
                    style="position: absolute; top: 70%; left: 50%; transform: translate(-50%, -50%); text-align: center;">
            ...
            <div class="row" style="margin-left: 0vw;cursor: pointer;">
                <div class="inner-box topik-box" id="topik_<?php echo $item['kode_topik']; ?>"
                    ...
                    style="background-color: #375679; width: 30vw; margin-right: 3vw; cursor: pointer; display:flex; align-items: center;">
                    <div
                        style="width: fit-content; border-radius: 4vw; font-size: 1vw; background-color: #ffffff; padding: 0.1vw 0.23vw; margin-right:0.6vw; color: #375679">
            ...
            <?php else: ?>
            <div style="cursor: pointer; display:flex; align-items: center;" class="inner-box topik-box"
                id="topik_<?php echo $item['kode_topik']; ?>" onclick="selectTopik(<?php echo $item['kode_topik']; ?>)">
                <div
